...
public class AutoTests {
    ...
    public void testFindByRegExpLogic() throws Exception {
    ...
    public void testFindClientByIdLogic() throws Exception {

        this.mockMvc.perform(get("/search_by_id").param("id", "1000000"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.result").value("ok"))
                .andExpect(jsonPath("$.contacts[0].name").value("rgaNEsLkC GAkook"));
    }
